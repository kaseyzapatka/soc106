...
In our first class, we will walk through downloading R onto your computer (<http://cran.rstudio.com>), as well as Positron, a free program that makes working in R much easier (<https://positron.posit.co/download.html>) and is at the cutting edge of data science right now. Downloading and installing R and Positron on Windows and Mac computers is straightforward.[^Mac] Installing them on a Chromebook may be more difficult; please let me know immediately if you are using a Chromebook for this course, and I will try to connect you with someone who can help with the installation.

[^Mac]: If you have a Mac, you need to check whether your laptop has an Apple Silicon (M1/M2) or Intel processor. Be sure to download the appropriate version of R and Positron for the Mac. You can check the process by:   
