...
**Question 3 — Continuous predictor.**
Interpret the coefficient on `Occupational Prestige`. Use this template:
...
**Question 4 — Categorical predictor.**
Interpret the coefficient on `Bachelor's Degree (vs. lt high)`. Remember: the baseline category is *less than high school*. Use this template:
...
**Question 6 — R².**
Report the R² value from the table and interpret it in one sentence. What proportion of variation in income does this model explain?
...
Look at the stars on the `Occupational Prestige` coefficient. Is this coefficient statistically significant at the α = 0.05 level? What does that mean — do you reject or fail to reject $H_0: \beta_{\text{prestige}} = 0$?
