...
p_actual_log <- tibble(resid = residuals(model_log)) |>
  ggplot(aes(x = resid)) +
  geom_histogram(bins = 40, fill = "#4E79A7", color = "white") +
  labs(title = "Our model: income91 → Log(income)",
       x = "Residual ($)", y = "Count") +
  theme_minimal(base_size = 10)
...
<tbody>
<tr><td style="padding:4px 8px;"><strong>Skin tone</strong></td><td style="background-color:#d0e4f5; text-align:center;">.187*</td><td style="background-color:#d0e4f5; text-align:center;">.029</td><td style="background-color:#fde8c8; text-align:center;">.088</td><td style="background-color:#fde8c8; text-align:center;">.208†</td></tr>
<tr><td style="padding:4px 8px;">Education</td><td style="background-color:#d0e4f5; text-align:center;">.053†</td><td style="background-color:#d0e4f5; text-align:center;">.127***</td><td style="background-color:#fde8c8; text-align:center;">.036</td><td style="background-color:#fde8c8; text-align:center;">.126***</td></tr>
<tr><td style="padding:4px 8px;">Income</td><td style="background-color:#d0e4f5; text-align:center;">.025</td><td style="background-color:#d0e4f5; text-align:center;">.054***</td><td style="background-color:#fde8c8; text-align:center;">.019</td><td style="background-color:#fde8c8; text-align:center;">.014</td></tr>
<tr><td style="padding:4px 8px;">Age</td><td style="background-color:#d0e4f5; text-align:center;">.034***</td><td style="background-color:#d0e4f5; text-align:center;">.033***</td><td style="background-color:#fde8c8; text-align:center;">.019**</td><td style="background-color:#fde8c8; text-align:center;">.030***</td></tr>
<tr><td style="padding:4px 8px;">Employed</td><td style="background-color:#d0e4f5; text-align:center;">.292</td><td style="background-color:#d0e4f5; text-align:center;">−.093</td><td style="background-color:#fde8c8; text-align:center;">.449†</td><td style="background-color:#fde8c8; text-align:center;">−.378</td></tr>
<tr><td style="padding:4px 8px;">N</td><td style="background-color:#d0e4f5; text-align:center;">1,036</td><td style="background-color:#d0e4f5; text-align:center;">1,036</td><td style="background-color:#fde8c8; text-align:center;">647</td><td style="background-color:#fde8c8; text-align:center;">647</td></tr>
<tr><td style="padding:4px 8px; border-top:1px solid #ccc;">R²</td><td style="background-color:#d0e4f5; text-align:center; border-top:1px solid #ccc;">.092</td><td style="background-color:#d0e4f5; text-align:center; border-top:1px solid #ccc;">.096</td><td style="background-color:#fde8c8; text-align:center; border-top:1px solid #ccc;">.072</td><td style="background-color:#fde8c8; text-align:center; border-top:1px solid #ccc;">.093</td></tr>
</tbody>
</table>

<small>†p ≤ .10. *p ≤ .05. **p ≤ .01. ***p ≤ .001. Coefficients are unstandardized OLS estimates from fully adjusted models (Model 4). Adapted from Thompson & Keith (2001), Tables 2 & 3.</small>
