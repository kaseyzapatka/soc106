...
model_log   <- lm(log(income91) ~ prestg80,     data = attain_reg)
...
# Select exactly 3 points (rows 10, 7, 65) for highlighted residuals
highlight_pts <- demo_df |> slice(c(10, 7, 65))
...
ggplot(demo_df, aes(x = prestg80, y = income91)) +
  ...
  scale_y_continuous(labels = scales::dollar_format()) +
  labs(
    title = "Observed values (grey dots) · Predicted values (blue line) · Residuals (red segments)",
...
## Coefficients and Hypothesis Tests {.smaller}
...
- For every one unit increase in occupational prestige, predicted household income increases by **$`r b1`**
- So, a person who moves from a prestige score of 30 to 60 (+30 points) is predicted to earn **$`r b1_30` more** per year
...
p_actual_log <- tibble(resid = residuals(model_log)) |>
  ggplot(aes(x = resid)) +
  geom_histogram(bins = 40, fill = "#4E79A7", color = "white") +
  labs(title = "Our model: Log(prestige) → income",
       x = "Residual ($)", y = "Count") +
  theme_minimal(base_size = 10)

(p_norm | p_skew) / (p_actual | p_actual_log) +
  plot_annotation(title = "Check normality of residuals with a histogram")
```
...
## What Do Control Variables Do? {.smaller}
...
## Multiple Regression {.smaller .scrollable}
...
**Coefficient on `Prestige Score` (bivariate → multiple):** $`r b1` → $`r b1_multi` per prestige point. After controlling for sex, the prestige slope changes slightly — this shift tells us how much of the bivariate prestige effect was actually due to sex differences in prestige.
...
**R² increase:** `r r2_biv`% (bivariate) → `r r2_multi`% (multiple regression). Adding sex explains additional variation in income beyond prestige alone — but most variation in income remains unexplained by these two predictors.
...
<tr>
  ...
  <th colspan="2" style="background-color:#4E79A7; color:white; text-align:center; padding:4px 8px; border-radius:4px 4px 0 0;">Women</th>
  <th colspan="2" style="background-color:#F28E2B; color:white; text-align:center; padding:4px 8px; border-radius:4px 4px 0 0;">Men</th>
</tr>
<tr>
  <th style="border-bottom:1px solid #ccc; text-align:left; padding:4px 8px;">Variable</th>
  <th style="background-color:#d0e4f5; text-align:center; padding:4px 8px;">Self-Esteem</th>
  <th style="background-color:#d0e4f5; text-align:center; padding:4px 8px;">Self-Efficacy</th>
  <th style="background-color:#fde8c8; text-align:center; padding:4px 8px;">Self-Esteem</th>
  <th style="background-color:#fde8c8; text-align:center; padding:4px 8px;">Self-Efficacy</th>
</tr>
</thead>
<tbody>
<tr><td style="padding:4px 8px;"><strong>Skin tone</strong></td><td style="background-color:#d0e4f5; text-align:center;">−0.04**</td><td style="background-color:#d0e4f5; text-align:center;">−0.05**</td><td style="background-color:#fde8c8; text-align:center;">−0.01</td><td style="background-color:#fde8c8; text-align:center;">0.02</td></tr>
<tr><td style="padding:4px 8px;">Education</td><td style="background-color:#d0e4f5; text-align:center;">0.03*</td><td style="background-color:#d0e4f5; text-align:center;">0.04**</td><td style="background-color:#fde8c8; text-align:center;">0.02</td><td style="background-color:#fde8c8; text-align:center;">0.03*</td></tr>
<tr><td style="padding:4px 8px;">Income</td><td style="background-color:#d0e4f5; text-align:center;">0.02</td><td style="background-color:#d0e4f5; text-align:center;">0.02</td><td style="background-color:#fde8c8; text-align:center;">0.01</td><td style="background-color:#fde8c8; text-align:center;">0.03*</td></tr>
<tr><td style="padding:4px 8px;">Age</td><td style="background-color:#d0e4f5; text-align:center;">−0.01**</td><td style="background-color:#d0e4f5; text-align:center;">−0.01**</td><td style="background-color:#fde8c8; text-align:center;">−0.01**</td><td style="background-color:#fde8c8; text-align:center;">−0.01**</td></tr>
<tr><td style="padding:4px 8px;">Employed</td><td style="background-color:#d0e4f5; text-align:center;">0.08</td><td style="background-color:#d0e4f5; text-align:center;">0.12*</td><td style="background-color:#fde8c8; text-align:center;">0.10*</td><td style="background-color:#fde8c8; text-align:center;">0.08</td></tr>
<tr><td style="padding:4px 8px;">N</td><td style="background-color:#d0e4f5; text-align:center;">~1,035</td><td style="background-color:#d0e4f5; text-align:center;">~1,035</td><td style="background-color:#fde8c8; text-align:center;">~581</td><td style="background-color:#fde8c8; text-align:center;">~581</td></tr>
<tr><td style="padding:4px 8px; border-top:1px solid #ccc;">R²</td><td style="background-color:#d0e4f5; text-align:center; border-top:1px solid #ccc;">.09</td><td style="background-color:#d0e4f5; text-align:center; border-top:1px solid #ccc;">.11</td><td style="background-color:#fde8c8; text-align:center; border-top:1px solid #ccc;">.07</td><td style="background-color:#fde8c8; text-align:center; border-top:1px solid #ccc;">.08</td></tr>
</tbody>
</table>

<small>*p < 0.05; \*\*p < 0.01. Coefficients are unstandardized OLS estimates. Adapted from Thompson & Keith (2001), Table 2.</small>
