...
**Mode**: **2** — it occurs 3 times, more than any other value

**Median**: order the data: (`2, 2, 2, 3,` **3, 4,** `5, 6, 10, 15`). Two middle observations, so find the midpoint: **3.5**

**Mean**: `(5+2+10+4+3+2+6+15+3+2)/10` = **5.2**

Notice that mode (2) < median (3.5) < mean (5.2) — this is a sign of right skew, which the outliers 10 and 15 produce
