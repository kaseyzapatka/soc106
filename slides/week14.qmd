...
- Final paper, HW #11, In-class presentations
...
- Mediation analysis on your own research data

## Housekeeping {.smaller}

**Weekly Assignment #11**

- <span class="highlight">Due Thursday, April 24</span> — interaction analysis (from Week 13)

**In-class presentations**

- <span class="highlight">Monday, April 28</span> — 7–10 minutes per student
- Slide template on the course site; structure: question → data → results → so what
- Practice out loud at least once before class

**Final paper**

- <span class="highlight">Due Monday, May 5</span>
- Should include at least: bivariate model, multivariate model with controls, and one extension (interaction, mediation, or logistic)
- Today's lecture covers mediation and multicollinearity — both are relevant to writing up results
...
**HW #11** — <span class="highlight">Due Thursday, April 24</span>

- Interaction analysis on your research data
- See Week 13 slides for the template

**Final Paper** — <span class="highlight">Due Monday, May 5</span>
...
**In-class presentations** — <span class="highlight">Monday, April 28</span>
...
- What is your X (key predictor)?
- What is your Y (outcome)?
- What variable M sits on the causal path between them?
- Write one sentence: "I expect [X] to affect [Y] partly through [M] because..."
:::
...
# Replace X, M, Y with your variable names
step1 <- lm(Y ~ X,     data = your_data)   # total effect
step2 <- lm(M ~ X,     data = your_data)   # a path
step3 <- lm(Y ~ X + M, data = your_data)   # b path + direct effect
```
:::
...
med_result <- mediate(step2, step3, treat = "X", mediator = "M",
                      boot = TRUE, sims = 500)
summary(med_result)
```
:::
...
::: {.fragment .fade-up}
**Step 4: Check multicollinearity on your final multivariate model**

```{r}
#| echo: true
#| eval: false
vif(your_multivariate_model)
```
:::
