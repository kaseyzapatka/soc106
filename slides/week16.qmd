...
- See [In-Class Presentation page](https://bcourses.berkeley.edu/courses/1551992/assignments/9023055) for presentation assignments
- Use [slide template](https://docs.google.com/presentation/d/1HJWAWjY6M1q7qL2f9029MmjlVGw9nUpg/edit?slide=id.p1#slide=id.p1) on the course site; structure: question → data → results → so what
...
- Should follow the formatting described in the [final paper outline](https://www.kaseyzapatka.com/soc106/assignments/_paper/03_proposal_outline.html) 
...
## How to Study For Final Exam {.smaller}
