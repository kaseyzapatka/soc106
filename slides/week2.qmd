...
-   Basics of using R and Positron
-   How to load data
-   How to complete homework

## What is Positron? {.smaller}

**Positron** is an Integrated Development Environment (IDE)—a complete workspace for writing, testing, and managing code in one window.
...
- Console/terminal to run code
- File browser for your projects
- Debugging tools
- Version control (Git)
:::
...
- Work with R and Python in the same environment
- No need to switch between different IDEs

### Modern & Flexible

- Streamlined workflow for data science
...
- [air](https://open-vsx.org/extension/posit/air-vscode) (formatting code)
- [GitLens](https://open-vsx.org/extension/eamodio/gitlens) (Git)
- [Quarto](https://open-vsx.org/extension/quarto/quarto) (publishing)
- [Docker](https://open-vsx.org/extension/ms-azuretools/vscode-docker) (websites)

Browse more at [Open VSX Registry](https://open-vsx.org/)
...
[Andrew Heiss' blog](https://www.andrewheiss.com/blog/2024/07/08/fun-with-positron/#my-extensions) for tips and use cases
...
-   Windows: highlight the entire line, and hit `Ctrl + Enter`
...
Use bracket at end of vector name with index, with first element indexed as 1.
...
Use `nth()` function to do the same thing, but still need indexing sometimes
...
A dataframe is a list of equal-length vectors, in this course, we'll focus on using **tidy dataframe**, which organize data so that:
...
| Obs 1  | Alice   | 22  | TRUE     |
| Obs 2  | Bob     | 25  | TRUE     |
| Obs 3  | Charlie | 19  | FALSE    |

: {.striped}

:::

## Creating Tidy Dataframes {.smaller}
...
## Markdown Basics {.smaller .scrollable}

Read more about [markdown coding](https://quarto.org/docs/authoring/markdown-basics.html) you might want to use. Here are the basics:
