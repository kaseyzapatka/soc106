...
2.  R basics: variables, data types, and logical operators
3.  Data structures and file paths vectors and dataframes
5.  The Tidyverse and key functions
6.  **Lab**: Setting up your folder structure and practicing with `.qmd` files
7.  **HW #0**: Complete and submit in class
