...
## R Functions for Distributions: The `d`/`p`/`q` Pattern {.smaller}
...
|---|---|---|---|
| **`d`** | **d**ensity / probability at a point | "What's the probability of **exactly** this value?" | `dbinom(6, size=10, prob=0.6)` |
| **`p`** | cumulative **p**robability | "What's the probability of getting **at most** this value?" | `pbinom(6, size=10, prob=0.6)` |
...
## Practice: Z-Scores and Normal Probabilities {.smaller}
