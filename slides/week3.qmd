...
ggplot(data = attain, aes(x = age)) +
  # set binwidth to 10
  geom_histogram(binwidth = 10, fill = "#4CBB17") +
  labs(
    title = "Age Distribution",
    x = "Age",
    y = "Frequency"
...
Let's [look at an example](https://www.kaseyzapatka.com/soc106/assignments/hw0.html) to better understand what I'm asking.
