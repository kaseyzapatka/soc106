...
- The sample proportion of the number of times the outcome occurred is the **probability**^[This is an estimate that improves as we observe more trials]
...
## Union of Events and the Addition Rule {.smaller}
...
Note that conditional probability is equivalent to the **marginal frequency** from last week — probability theory connects directly to descriptive statistics
